...
def run_onacid_from_file(caiman_params):
    method = 'ShufflenetV2' # TPOT, CNN or ShufflenetV2
    ...
    onacid.fit_from_file(
        input_video_path='data/raw/neurofinder/neurofinder.03.00/images/',
        ...
        mov_key='Object',
        output_dir=f'data/out/neurofinder.03.00/{method}/',
        with_plot=True
    )
